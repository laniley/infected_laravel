	...
	public function up()
	{
		DB::statement( 'CREATE VIEW v_quests AS
			SELECT
				...
				from quests left join quest_fulfillment_conditions as ful
				on ful.quest_id = quests.id

				left join quest_fulfillment_condition_types as ful_type
				on ful.quest_fulfillment_condition_type_id = ful_type.id
